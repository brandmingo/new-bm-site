  ...
  const sliderCards = [
    {
      ...
      desc: "We design visually stunning Shopify stores with strategic layouts, clean UI, and persuasive product pages that turn visitors into paying customers.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
...

    {
      ...
      desc: "From theme customization to advanced functionality, we build fully tailored Shopify stores that reflect your brand identity and business goals.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      title: "Fast, Secure & High-Performance Stores",
      desc: "We optimize your Shopify store for lightning-fast loading, secure transactions, and smooth performance to ensure maximum customer satisfaction and trust.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
...

    {
      ...
      desc: "We create mobile-optimized Shopify stores that grow with your business and help you sell seamlessly across cities, countries, and global markets.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      title: "Scalable, Mobile-First & Global Ready",
      desc: "We create mobile-optimized Shopify stores that grow with your business and help you sell seamlessly across cities, countries, and global markets.",
      icon: (
        <svg
          className="w-6 h-6"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16 md:py-24">
          ...
          <div className="border-t border-[#f4a702]/30 pt-6 sm:pt-8 mb-0">
            <div className="flex items-center justify-center gap-1 text-xs sm:text-sm">
              ...
              <span className="text-[#f4a702] font-medium">Shopify</span>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center min-h-[50vh] sm:min-h-[60vh] space-y-4 sm:space-y-6 px-4">
            ...
            <p className="max-w-3xl text-center text-gray-200 text-xs sm:text-sm md:text-base px-2">
              At Brandmingo, we create powerful Shopify stores that are fast,
              secure, and built to convert. Our custom Shopify solutions help
              your brand attract, engage, and sell effortlessly.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            <h2 className="text-4xl md:text-5xl font-extrabold">
              <span className="text-white">Shopify Solutions Built </span>
              <span className="text-[#f4a702]">for Sales, Scale & Speed</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">
              ...
              <span className="text-[#f4a702]">Brandmingo Shopify Way</span>
            </h2>
            <p className="text-gray-400 text-sm sm:text-base max-w-2xl mx-auto">
              At BrandMingo, we don’t just build Shopify stores — we create
              high-converting, scalable, and performance-driven e-commerce
              experiences designed to maximize sales and long-term growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-8 sm:p-10 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4 group-hover:text-white transition-colors duration-300">
                  Your Business, Your Shopify Blueprint
                </h3>
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed group-hover:text-white/90 transition-colors duration-300">
                  Every Shopify store we build is customized around your brand
                  identity, product strategy, and audience behavior to ensure
                  uniqueness, strong positioning, and scalable success.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  Our streamlined Shopify development process ensures fast
                  delivery without compromising quality — from store setup to
                  payment integration and final launch.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  From store setup, theme customization, app integration, to
                  post-launch maintenance — we manage the complete Shopify
                  lifecycle so you can focus on growing your business.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  Every Shopify store is built with scalability, security, and
                  future expansion in mind — ensuring smooth performance as your
                  business grows.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  Fast loading, secure checkout, optimized mobile experience,
                  and conversion-focused UX — we design every Shopify store to
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  We don’t just deliver Shopify stores — we partner with you as
                  your growth team, aligning with your vision, timelines,
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">
              ...
              <span className="text-[#f4a702]">Shopify Growth Blueprint</span>
            </h2>
            <p className="text-gray-400 text-sm sm:text-base max-w-3xl">
              At BrandMingo, we follow a structured, performance-driven Shopify
              development process focused on sales growth, seamless user
              experience, and long-term scalability. Every stage is designed to
              maximize conversions and store stability.
            </p>
          </div>
            ...
            <div className="space-y-8 md:space-y-12">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  <div className="flex items-center gap-3 mb-2">
                    <h3 className="text-lg sm:text-xl font-bold text-white">
                      Market Research & Store Planning
                    </h3>
                    <svg
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    We analyze your products, competitors, pricing strategy, and
                    target customers to craft a Shopify store roadmap that
                    aligns perfectly with your business goals and growth vision.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Our UI/UX experts design visually appealing, trust-building,
                    and mobile-optimized Shopify layouts that enhance customer
                    engagement and simplify the buying journey.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    We develop your Shopify store using clean, scalable code
                    with theme customization, app integrations, secure payment
                    gateways, and smart inventory sync
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Before launch, your store goes through speed optimization,
                    mobile responsiveness testing, secure checkout validation,
                    and performance tuning for flawless operation.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    We configure taxes, shipping, payment systems, analytics,
                    and marketing tools before deploying your Shopify store for
                    a smooth and successful live launch.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    After launch, we provide continuous monitoring, updates,
                    performance tracking, marketing readiness, and technical
                    support to keep your store profitable and scalable
                  </p>
                </div>
              </div>
            </div>
