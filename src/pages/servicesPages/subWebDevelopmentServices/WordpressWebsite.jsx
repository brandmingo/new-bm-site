...
function WordpressWebsite() {
  ...
  const sliderCards = [
    {
      title: "Custom-Tailored WordPress Websites",
      desc: "Your business is unique — and your website should be too We design fully customized, brand-aligned WordPress websites built for impact, trust, and conversion",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      title: "Fast, Secure & Optimized Performance",
      desc: "From lightning-fast load speeds to airtight security and SEO-friendly architecture, our WordPress builds ensure maximum performance and long-term stability.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      title: "Easy Management with Powerful CMS",
      desc: "No technical skills needed — manage pages, blogs, products, and content effortlessly with a clean, intuitive WordPress admin panel built for simplicity and control.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      title: "Mobile-Ready & Future-Proof Design",
      desc: "Your customers browse from everywhere We create mobile-optimized, responsive layouts that adapt beautifully to every device — ensuring a seamless experience across all screens.",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
    ...
    {
      title: "SEO-Ready & Lead-Optimized Structure",
      desc: "A beautiful website is useless if it can't be found. We build every WordPress website with SEO-ready architecture, fast indexing, and conversion-focused layouts to help you rank higher, attract organic traffic, and generate quality leads consistently",
      icon: (
        <svg
          className="w-6 h-6"
          fill="none"
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 py-12 sm:py-16 md:py-24">
          ...
          <div className="flex flex-col items-center justify-center min-h-[50vh] sm:min-h-[60vh] space-y-4 sm:space-y-6 px-4">
            ...
            <p className="max-w-3xl text-center text-gray-200 text-xs sm:text-sm md:text-base px-2">
              We craft powerful, scalable, and visually stunning WordPress
              websites that help your brand grow faster online. From business
              websites to custom WordPress solutions, Brandmingo delivers
              performance-driven designs built for speed, security, and success.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-10">
            <h2 className="text-4xl md:text-5xl font-extrabold">
              <span className="text-white">WordPress Solutions Built</span>
              <span className="text-[#f4a702]">for Performance & Growth</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">
              ...
              <span className="text-[#f4a702]">Brandmingo WordPress Way</span>
            </h2>
            <p className="text-gray-400 text-sm sm:text-base max-w-2xl mx-auto">
              At Brandmingo, we don’t just build WordPress websites — we craft
              powerful, scalable digital experiences that are fast, secure,
              SEO-ready, and designed to convert visitors into loyal customers
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2 group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-8 sm:p-10 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl sm:text-3xl font-bold text-white mb-4 group-hover:text-white transition-colors duration-300">
                  Your Business, Your WordPress Blueprint
                </h3>
                <p className="text-gray-300 text-sm sm:text-base leading-relaxed group-hover:text-white/90 transition-colors duration-300">
                  No templates. No limitations. Every WordPress website we build
                  is custom-crafted around your brand identity, business goals,
                  and target audience to ensure uniqueness and long-term
                  success.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  We follow a streamlined WordPress development process that
                  ensures faster delivery without compromising quality — from
                  planning to deployment, everything moves with precision.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-white transition-colors duration-300">
                  End-to-End WordPress Support
                </h3>
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  From website strategy, UI design, development, plugin
                  integration to post-launch maintenance — we handle your
                  complete WordPress lifecycle so you can focus on growth.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-white transition-colors duration-300">
                  Growth-First WordPress Technology
                </h3>
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  Our WordPress solutions are built for speed, scalability,
                  security, and future expansion — so your website grows
                  effortlessly as your business scales.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-white transition-colors duration-300">
                  Performance-Driven WordPress Development
                </h3>
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  Every WordPress website we build is optimized for fast
                  loading, smooth user experience, SEO performance, and high
                  conversion — because performance directly impacts revenue.
                </p>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 p-6 sm:p-8 hover:border-transparent transition-all duration-500">
              ...
              <div className="relative z-10">
                ...
                <p className="text-gray-400 text-sm leading-relaxed group-hover:text-white/80 transition-colors duration-300">
                  We don’t just deliver projects — we partner with you. Our
                  WordPress experts work as an extension of your team, aligned
                  with your vision, timelines, and success goals.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-4">
              ...
              <span className="text-[#f4a702]">WordPress Blueprint</span>
            </h2>
            <p className="text-gray-400 text-sm sm:text-base max-w-3xl">
              At Brandmingo, we follow a proven, result-driven process to build
              powerful, secure, and conversion-focused WordPress websites. Every
              step is carefully designed to deliver performance, scalability,
              and long-term digital success for your brand.
            </p>
          </div>
            ...
            <div className="space-y-8 md:space-y-12">
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    We begin by understanding your business goals, brand
                    identity, target audience, and competitors. This helps us
                    define the right WordPress strategy, structure, and feature
                    set for maximum impact.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    We craft intuitive, visually engaging, and user-focused
                    WordPress interfaces that offer smooth navigation and create
                    a premium browsing experience across all devices.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Using clean code, secure frameworks, and the latest
                    WordPress technologies, we develop fast-loading, scalable,
                    and fully functional websites tailored to your business
                    needs.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Every website goes through rigorous performance, security,
                    and responsiveness testing to ensure flawless functionality
                    on all browsers and screen sizes.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Once everything is perfected, we deploy your WordPress
                    website with complete configuration, speed optimization, and
                    live environment setup for a smooth and successful launch.
                  </p>
                </div>
              </div>
              ...
              <div className="relative flex items-start md:items-center gap-4 md:gap-8 group">
                ...
                <div className="flex-1 bg-gradient-to-br from-gray-900/80 to-black border border-gray-800 rounded-2xl p-4 sm:p-6 hover:border-[#f4a702]/50 hover:shadow-lg hover:shadow-[#f4a702]/20 transition-all duration-300 group-hover:translate-x-2">
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    ...
                    maintenance, performance monitoring, updates, security
                    patches, and growth optimization to keep your website
